...
The StoreFront Child Theme is a starter blank child theme for StoreFront theme.

## Installation

1. Download the child theme from it's GitHub Repository [Download StoreFront Ubricks Child Theme](https://github.com/DxDiagDx/ubricks-storefront-child-theme).
